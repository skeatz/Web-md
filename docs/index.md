...
This is an example student blog for the Digital Fabrication & Prototyping Fundamentals module.

## How to edit it

You can edit it on [GitHub](https://github.com). The software used turns simple text files
